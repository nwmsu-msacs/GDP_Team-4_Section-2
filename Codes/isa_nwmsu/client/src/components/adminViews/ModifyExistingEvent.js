...
class ModifyExistingEvent extends React.Component {
  ...
  onSubmit = (e) => {
    ...
    axios.put('http://localhost:5000/api/events/modify/'+localStorage.getItem("eventId"), newevent)
      .then(res => console.log(res.data))
      .then(this.props.history.push("/manageEvents"))
...
export default ModifyExistingEvent;
